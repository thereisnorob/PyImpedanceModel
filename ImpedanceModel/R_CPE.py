...
class R_CPE(ImpedanceModelElement):
    ...
    def __init__(self, R_Ohm: float = 0.01, tau_s: float = 1, n_1: float = 0.95):
        """
        Equivalent circuit element: Resistore-CPE-parallel element
        ...
        """
        self.set_parameters(R_Ohm, tau_s, n_1)
    ...
    def evaluate(self, frequency_Hz: npt.ArrayLike) -> npt.ArrayLike:
        ...
        return self.R_Ohm / (1 + (1j * 2 * np.pi * frequency_Hz * self.tau_s) ** self.n_1)
